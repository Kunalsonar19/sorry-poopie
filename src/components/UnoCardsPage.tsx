...
import Music1 from "../music/Tum Se Hi.mp3";
import Music2 from "../music/bulleya.mp3";
import Music3 from "../music/Swapna.mp3";
import Music4 from "../music/Tujh Mein.mp3";
...
const UnoCardsPage: React.FC<UnoCardsPageProps> = ({ onNext }) => {
  const cards: UnoCardData[] = [
    {
      ...
      photoUrl: Img1,
      caption:
        "This is how I love you laughing, glowing, making everything better.",
      musicName: "Tum Se Hi - ",
      musicUrl: Music1,
    },
    {
      ...
      photoUrl: Img2,
      caption:
        "This is what I see when you're angry with me but even then, you're soo cute.",
      musicName: "Bulleya - ",
      musicUrl: Music2,
    },
    {
      ...
      photoUrl: Img3,
      caption:
        "This is how I imagine us when everything feels messed, you in my arms.",
      musicName: "Swapna -",
      musicUrl: Music3,
    },
    {
      ...
      photoUrl: Img4,
      caption:
        "POV: When she loves pizza more than you, but you still feed her.",
      musicName: "Tujh Mein - ",
      musicUrl: Music4,
    },
  ];
  ...
  return (
    ...
    >
      <h2 className="text-white text-3xl font-bold text-center mb-12 p-3">
        काही गोष्टी बोलायच्या होत्या, पण बोलता आलं नाही… आता ऐकून घे
      </h2>
